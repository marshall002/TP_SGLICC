...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageInicio.master" AutoEventWireup="true" CodeFile="ver-informacion-inmueble-usuario.aspx.cs" Inherits="pages_ver_informacion_inmueble_usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div="ver_publicacion" class="contenedor-publicacion">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             ...
             <div id="PropietarioDatos" class="row-personalizado-publicacion col-lg-9 col-md-9 col-sm-9 col-xs-9">
                         ...
                         <asp:Label ID="lblPropietario" runat="server" Text="Propietario" CssClass="texto-publicacion-venta"></asp:Label>
                         </div>

                         <div>
                         <span  class="help-block"></span>
                         <asp:TextBox ID="txtPropietario" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                         </div>
                         </div>
                         ...
                         <div class="fila2-caja1">
                         <asp:Label ID="lblDNI" runat="server" Text="DNI" CssClass="texto-publicacion-venta"></asp:Label>
                         </div>
             ...
             <div id="PropietarioDatos1" class="row-personalizado-publicacion col-lg-9 col-md-9 col-sm-9 col-xs-9">
                         <div class="row-perso-reg fila2-contenedor1 col-lg-5 col-md-5 col-sm-5 col-xs-5 " style="padding-right: 0px !important; padding-left: 0px !important">
                         <div class="fila2-caja1">
                         <asp:Label ID="lblCelular" runat="server" Text="Celular" CssClass="texto-publicacion-venta"></asp:Label>
                         </div>
                         ...
                         <div class="row-perso-reg fila2-contenedor2 col-lg-5 col-md-5 col-sm-5 col-xs-5" style="padding-right: 0px !important; padding-left: 0px !important">
                         <div class="fila2-caja1">
                         <asp:Label ID="lblTelefono" runat="server" Text="Telefono" CssClass="texto-publicacion-venta"></asp:Label>
                         </div>
                 ...
                 <div id="DatosAviso" class="row-personalizado-publicacion col-lg-9 col-md-9 col-sm-9 col-xs-9">
                  ...
                  <div class="fila1-crear-publicacion-venta col-lg-9 col-md-9 col-sm-9 col-xs-9">                                                 
                         <div class="fila1-caja1">
                         <asp:Label ID="lblTitulo" runat="server" Text="Titulo" CssClass="texto-publicacion-venta"></asp:Label>
                         </div>
      ...
      $(function() {
       ...
       <div id="caracteristicas_inmueble" class="row-personalizado-publicacion col-lg-9 col-md-9 col-sm-9 col-xs-9">
           ...
           <div id="Tipo_de_Publicacion" class="row-perso-reg fila2-contenedor1 col-lg-4 col-md-4 col-sm-4 col-xs-4 " style="padding-right: 0px !important; padding-left: 0px !important; margin-right:auto;margin-left:auto"">
              ...
              <div id="Detalles" class="row-perso-reg fila2-contenedor1 col-lg-4 col-md-4 col-sm-4 col-xs-4 " style="padding-right: 0px !important; padding-left: 0px !important; margin-right:auto;margin-left:auto"">
                         <div class="fila2-caja1">
                         ...
                         <asp:Label ID="lblDetalles" runat="server" CssClass="texto-publicacion-venta" Text="Detalles"></asp:Label>                         
                            ...
                            <div>
                         <span  class="help-block"></span>
                      <asp:TextBox ID="txtDetalles" runat="server" Class="form-control-personalizado-crear-publicacion-venta col-lg-10 col-md-10 col-sm-10 col-xs-10"></asp:TextBox>
                         </div>
                        </div>
             <div id="Tipo_Suelo" class="row-perso-reg fila2-contenedor1 col-lg-4 col-md-4 col-sm-4 col-xs-4 " style="padding-right: 0px !important; padding-left: 0px !important; margin-right:auto;margin-left:auto"">
                         <div class="fila2-caja1">
                         
                         <asp:Label ID="lblTipoSuelo" runat="server" CssClass="texto-publicacion-venta" Text="Tipo Suelo"></asp:Label>                         
                         </div>
                            <div>
                         <span  class="help-block"></span>
                      <asp:TextBox ID="txtTipoSuelo" runat="server" Class="form-control-personalizado-crear-publicacion-venta col-lg-10 col-md-10 col-sm-10 col-xs-10" ReadOnly="true"></asp:TextBox>
                         </div>
                        </div>
            <div id="Area_Total" class="row-perso-reg fila2-contenedor1 col-lg-4 col-md-4 col-sm-4 col-xs-4 " style="padding-right: 0px !important; padding-left: 0px !important; margin-right:auto;margin-left:auto"">
                         <div class="fila2-caja1">
                         
                         <asp:Label ID="lblArea_Total" runat="server" CssClass="texto-publicacion-venta" Text="Area Total"></asp:Label>                         
                         </div>
                            <div>
                         <span  class="help-block"></span>
                      <asp:TextBox ID="txtArea_Total" runat="server" Class="form-control-personalizado-crear-publicacion-venta col-lg-10 col-md-10 col-sm-10 col-xs-10" ReadOnly="true"></asp:TextBox>
                         </div>
                        </div>
            <div id="registro_publicacion" class="row-personalizado-publicacion col-lg-9 col-md-9 col-sm-9 col-xs-9" Style="display:flex !important">
             <div id="Regresar" class="row-personalizado-publicacion col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                 <div id="lblRegresar" class="row-perso-reg fila2-contenedor1 col-lg-5 col-md-5 col-sm-5 col-xs-5 " style="padding-right: 0px !important; padding-left: 0px !important; margin-right:auto">
                         <div class="fila2-caja1">
                           <span  class="help-block"></span>
                  <asp:Button ID="Button4" runat="server" CssClass="btn btn-primary" Style="float:right !important;margin-left:auto !important;" Text="Regresar" OnClientClick="javascript: return history.back()"/>
                             
                         </div>
      </div>
   
                            </div>
                        <div id="Consultar" class="row-personalizado-publicacion col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                 <div id="lblConsultar" class="row-perso-reg fila2-contenedor1 col-lg-5 col-md-5 col-sm-5 col-xs-5 " style="padding-right: 0px !important; padding-left: 0px !important; margin-right:auto">
                         <div class="fila2-caja1">
                           <span  class="help-block"></span>
                  <asp:Button ID="Button5" runat="server" CssClass="btn btn-primary" Style="float:right !important;margin-left:auto !important;" Text="Consultar" OnClick="btnConsultar_Click"/>
                        ...
                        <div id="Guardar en Favoritos" class="row-personalizado-publicacion col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                 <div id="lblGF" class="row-perso-reg fila2-contenedor1 col-lg-5 col-md-5 col-sm-5 col-xs-5 " style="padding-right: 0px !important; padding-left: 0px !important; margin-right:auto">
                         <div class="fila2-caja1">
                           <span  class="help-block"></span>
                  <asp:Button ID="Button6" runat="server" CssClass="btn btn-primary" Style="float:right !important;margin-left:auto !important;" Text="Favoritos" OnClick="btnGF_Click"/>
                        ...
                        <div id="Comprar" class="row-personalizado-publicacion col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                 <div id="lblComprar" class="row-perso-reg fila2-contenedor1 col-lg-5 col-md-5 col-sm-5 col-xs-5 " style="padding-right: 0px !important; padding-left: 0px !important; margin-right:auto">
                         <div class="fila2-caja1">
                           <span  class="help-block"></span>
                  <asp:Button ID="Button7" runat="server" CssClass="btn btn-primary" Style="float:right !important;margin-left:auto !important;" Text="Comprar" OnClick="btnComprar_Click"/>
  ...
  <script>
      ...
      window.onload = function () {
          alert('Hola');
             ...
             $('#<%=lblPropietario.ClientID%>').css({ "color": "blue" });
             $('#<%=lblTiempo.ClientID%>').css({ "color": "blue" });
             $('#<%=lblDNI.ClientID%>').css({ "color": "blue" });
             $('#<%=lblCelular.ClientID%>').css({ "color": "blue" });
             $('#<%=lblTelefono.ClientID%>').css({ "color": "blue" });
             ...
             var tipo_inmueble = document.getElementById("<%=txtTipoInmueble.ClientID%>").value;
             if (tipo_inmueble == "Casa") {
                 $("#Caracteristicas").hide();
                 $("#Departamento_por_piso").hide();
                 $("#Caracteristicas").hide();
                 $("#Detalles").hide();
                 $("#Tipo_Suelo").hide();
                 $("#Area_Total").hide();
