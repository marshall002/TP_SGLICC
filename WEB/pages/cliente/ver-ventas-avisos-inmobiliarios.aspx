...
<%@ Page Title="" Language="C#" MasterPageFile="~/pages/MasterPagePanel.master" AutoEventWireup="true" CodeFile="ver-ventas-avisos-inmobiliarios.aspx.cs" Inherits="pages_cliente_ver_ventas_avisos_inmobiliarios" %>
     ...
     <div class="body table-responsive">
        ...
        <div class="">
                       <%-- <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>--%>   <%--table table-bordered table-hover--%>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="gvVerVentasAI" runat="server" DataKeyNames="id_persona,Codigo,Estado" CssClass="contenedor-gridview"  AutoGenerateColumns="False" EmptyDataText="No hay ventas de avisos inmobiliarios registrados" ShowHeaderWhenEmpty="True" OnRowCommand="gvVerVentasAI_RowCommand" OnSelectedIndexChanged="gvVerVentasAI_SelectedIndexChanged" AllowPaging="true" OnPageIndexChanging="gvVerVentasAI_PageIndexChanging">
