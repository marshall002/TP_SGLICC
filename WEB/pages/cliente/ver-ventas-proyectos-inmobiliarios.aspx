<%@ Page Title="" Language="C#" MasterPageFile="~/pages/MasterPagePanel.master" AutoEventWireup="true" CodeFile="ver-ventas-proyectos-inmobiliarios.aspx.cs" Inherits="pages_cliente_ver_ventas_proyectos_inmobiliarios" %>
     ...
     <div class="body table-responsive">
        ...
        <div class="">
                       <%-- <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>--%>   <%--table table-bordered table-hover--%>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="gvVerVentasProyectosInmobiliarios" runat="server" DataKeyNames="Codigo" CssClass="contenedor-gridview"  AutoGenerateColumns="False" EmptyDataText="No hay ventas de proyectos inmobiliarios registrados" ShowHeaderWhenEmpty="True" OnRowCommand="gvVerVentasProyectosInmobiliarios_RowCommand" OnSelectedIndexChanged="gvVerVentasProyectosInmobiliarios_SelectedIndexChanged" AllowPaging="true" OnPageIndexChanging="gvVerVentasProyectosInmobiliarios_PageIndexChanging">
