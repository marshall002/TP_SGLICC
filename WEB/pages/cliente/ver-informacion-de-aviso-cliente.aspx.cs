...
public partial class pages_cliente_ver_informacion_de_aviso_cliente : System.Web.UI.Page
{
    ...
    public void EvaluarCliente()
    {
        ...
        string var = Session["estado"].ToString();
        if(var.Equals("Comprado"))
        {
            btnAceptarAviso.Text = var;
    ...
    public void Carga_Informacion_del_Propietario()
    {
        ...
        dto_persona.id_persona = int.Parse(Session["id_personax"].ToString());
    ...
    public void CargarInformaciondelAviso()
    {
        ...
        dto_aviso.codigo = int.Parse(Session["codigo"].ToString());
    ...
    public void CargarImagenes()
    {
        ...
        dto_aviso1.codigo = int.Parse(Session["codigo"].ToString());
    ...
    {
        string evaluar = Session["condicion"].ToString(); 
        if(evaluar.Equals("Ventas"))
        {
            ...
            DtoUsuario []dto_usuarios = new DtoUsuario[100];
            dto_usuario.id_perfil = 2;
            CtrCliente ctr_cliente = new CtrCliente();
            List<DtoUsuario> list_id = new List<DtoUsuario>();
            list_id = ctr_cliente.Ctr_EncontrarPerfil(dto_usuario);
            for(int i=0;i<list_id.Count();i++)
            {
                dto_usuarios[i] = list_id.ElementAt(i);
            }
            for (int i = 0; i < list_id.Count(); i++)
            {
                dto_persona.id_persona = int.Parse(dto_usuarios[i].id_persona.ToString());
                ...
                dto_notificacion.titulo = "Solicito inhabilitacion del aviso: " + Session["codigo"].ToString();
