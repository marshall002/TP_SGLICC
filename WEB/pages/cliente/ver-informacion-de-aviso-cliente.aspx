<%@ Page Title="" Language="C#" MasterPageFile="~/pages/MasterPagePanel.master" AutoEventWireup="true" CodeFile="ver-informacion-de-aviso-cliente.aspx.cs" Inherits="pages_cliente_ver_informacion_de_aviso_cliente" %>
    ...
    <div id="ver_publicacion" class="contenedor-publicacion">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             ...
             <div id="PropietarioDatos" class="row-personalizado-publicacion col-lg-9 col-md-9 col-sm-9 col-xs-9">
                         ...
                         <asp:TextBox ID="txtPropietario" runat="server" Class="form-control" ReadOnly="true"></asp:TextBox>
                         </div>
                         </div>
     ...
     <div class="row-perso-reg" style="float:right;margin-left:auto">
                       ...
                       <ContentTemplate>
                        ...
                        <button class="btn btn-danger" type="button" id="btnRechazar" data-toggle="modal" data-target="#Rechazar" aria-haspopup="true" aria-expanded="false" runat="server" style="float: right;margin-right:20px;">Inhabilitar Aviso</button>
                       </ContentTemplate>
                       <Triggers>
                       ...
                       ChildrenAsTriggers="true" >
                       <ContentTemplate>
                       <asp:Button ID="btnAceptarAviso" runat="server" CssClass="btn btn-success" Style="float:right !important;margin-left:auto !important;" Text="Regresar" OnClick="btnAceptarAviso_Click" OnClientClick="javascript: return history.back()"/>
                       </ContentTemplate>
                       <Triggers>
                       <asp:AsyncPostBackTrigger ControlID="btnAceptarAviso" EventName="Click" />
                       </Triggers>
