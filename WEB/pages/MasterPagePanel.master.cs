    ...
    public void perfil_jefe_de_ventas()
    {
        ...
        string html = string.Format(@"
                   <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                    ...
                    <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                         <a class='nav-link nav-link-collapse collapsed' data-toggle='collapse' href ='#SupervisarAvisos' data-parent='#exampleAccordion'>
                            <i class='material-icons'>accessibility</i><span class='nav-link-text'> Supervisar Avisos Inmobiliarios</span>
                        </a>
                        <ul class='sidenav - second - level collapse' id='SupervisarAvisos'>
                            <li>
                                <a class='nav-link' href='~/pages/personal/jefe_de_ventas/supervisar-avisos-inmobiliarios.aspx'> Avisos Inmobiliarios</a>
                            </li> 
                             <li>
                                <a class='nav-link' href='~/pages/personal/jefe_de_ventas/supervisar-proyectos-inmobiliarios.aspx'> Proyectos Inmobiliarios</a>
                            </li>
                     ...
                     <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                        ...
                        <ul class='sidenav - second - level collapse' id='c'>
                            <li>
                                <a class='nav-link' href='~/pages/personal/jefe_de_ventas/reporte-de-ventas.aspx'> Reporte de Ventas</a>
                            </li>  
                   ...
                   <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                    ...
                    <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                        ...
                        <ul class='sidenav - second - level collapse' id='Actividad'>                           
                            <li>
                                <a class='nav-link' href='/pages/personal/jefe_de_compras/supervisar-compras-de-inmueble.aspx'> Supervisar Compras de Inmueble</a>
                            </li>                            
                        </ul>
                    </li>
           ...
           string html = string.Format(@"
                   <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                    ...
                    <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                     ...
                     <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                         <a class='nav-link nav-link-collapse collapsed' data-toggle='collapse' href ='#MisActividades' data-parent='#exampleAccordion'>
                            <i class='material-icons'>local_activity</i><span class='nav-link-text'>Consultar Actividades</span>
                        </a>
                        <ul class='sidenav - second - level collapse' id='MisActividades'>
                            <li>
                                <a class='nav-link' href='/pages/cliente/ver-ventas.aspx?idtipo=1'> Ver Ventas</a>
                            </li>  
                            <li>
                                <a class='nav-link' href='/pages/cliente/ver-compras.aspx?idtipo=1'> Ver Compras</a>
                            </li>  
                            <li>
                                <a class='nav-link' href='/pages/cliente/ver-favoritos.aspx?idtipo=1'> Ver Favoritos</a>
                            </li>   
                        </ul>
                    </li>
