<%@ Page Title="" Language="C#" MasterPageFile="~/pages/MasterPagePanel.master" AutoEventWireup="true" CodeFile="Detalles-compra.aspx.cs" Inherits="pages_personal_Jefe_de_Comprs_Detalles_compra" %>
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    ...
    <script>
        function redireccionar() {
            location.href="/pages/personal/Jefe%20de%20Compras/Supervisar-Compra-Inmueble.aspx";
        }
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             ...
             <div id="PropietarioDatos1" class="row-personalizado-publicacion col-lg-9 col-md-9 col-sm-9 col-xs-9">
                 ...
                 <div class="fila1-crear-publicacion-venta col-lg-9 col-md-9 col-sm-9 col-xs-9">
                         <div class="fila2-caja1">
                         <asp:Label ID="Label1" runat="server" Text="Solicitante" CssClass="texto-publicacion-venta"></asp:Label>
                         </div>

                         <div>
                         <span  class="help-block"></span>
                         <asp:TextBox ID="TxtComprador" runat="server" Class="form-control" ReadOnly="true"></asp:TextBox>
                         </div>
                         </div>
                     ...
                     <div class="contenido-direccion"><span style="color:green">Direccion Inmueble</span>
                        ...
                        <asp:TextBox id="txtDireccionInmueble" width="500px" runat="server" ReadOnly="true"></asp:TextBox>                           
                            ...
                            <div class="modal-footer">
                               <button type="button" class="btn btn-danger" data-dismiss="modal" id="boton_Cerrar">Cerrar</button>
                            </div>
                    </div>
                </div>
            </div>
