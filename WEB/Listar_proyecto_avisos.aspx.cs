...
public partial class Listar_ventas_avisos : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Listar_proyecto_usuario();

            }
            else
            {
                Listar_proyecto(int.Parse(Session["id_persona"].ToString()));
            }
    ...
    public void Listar_proyecto_usuario()
    {
        CtrAviso caviso = new CtrAviso();


        gvAventas.DataSource = caviso.Ctr_Listar_avisos_proyecto_usuario();
    ...
    public void Listar_proyecto(int id_persona)
{
        CtrAviso caviso = new CtrAviso();
       gvAventas.DataSource = caviso.Ctr_Listar_avisos_proyecto(id_persona);
        gvAventas.DataBind();
}
