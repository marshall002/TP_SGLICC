...
public partial class Listar_ventas_avisos : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Listar_alquiler_usuario();

            }
            else
            {
                Listar_alquiler(int.Parse(Session["id_persona"].ToString()));
            }
    ...
    public void Listar_alquiler_usuario()
    {
        CtrAviso caviso = new CtrAviso();


        gvAventas.DataSource = caviso.Ctr_Listar_avisos_alquiler_usuario();
    ...
    public void Listar_alquiler(int id_persona)
{
        CtrAviso caviso = new CtrAviso();
       gvAventas.DataSource = caviso.Ctr_Listar_avisos_alquiler(id_persona);
        gvAventas.DataBind();
}
