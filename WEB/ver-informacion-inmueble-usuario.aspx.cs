...
public partial class pages_ver_informacion_inmueble_usuario : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CargarSubCaractertisticas(txtTipoSuelo, 14);
        CargarSubCaractertisticas(txtArea_Total, 15);
    ...
    public void CargarSubCaractertisticas(TextBox Texto, int caracteristica)
    {
        ...
        if (list_sub_caracteristica_adicionales.Count() != 0)
        {
    ...
    public void Cargar_Nombres_Caracteristicas_del_Inmueble()
    {
        ...
        txtArea_Total.Attributes.Add("style", "background-color: white");
        txtTipoSuelo.Attributes.Add("style", "background-color: white");
        //--------------------------------------------------------------------
        ...
        lblGenerales.Attributes.Add("style", "color: blue");
         lblPropietario.Attributes.Add("style", "color: blue");
        lblTiempo.Attributes.Add("style", "color: blue");
        lblDNI.Attributes.Add("style", "color: blue");
        lblCelular.Attributes.Add("style", "color: blue");
        lblTelefono.Attributes.Add("style", "color: blue");
        lblAvisoTipo.Attributes.Add("style", "color: blue");
        lblTipoServicio.Attributes.Add("style", "color: blue");
        lblTipoInmueble.Attributes.Add("style", "color: blue");
        lblSubTipoInmueble.Attributes.Add("style", "color: blue");
        lblTitulo.Attributes.Add("style", "color: blue");
        lblDescripcion.Attributes.Add("style", "color: blue");
        lblMiDireccion.Attributes.Add("style", "color: blue");
        lblPrecio.Attributes.Add("style", "color: blue");
        lblFechaInicio.Attributes.Add("style", "color: blue");
        lblFechaFinal.Attributes.Add("style", "color: blue");
        lblImagen.Attributes.Add("style", "color: blue");
        lblNro_Pisos.Attributes.Add("style", "color: blue");
        lblTipodePublicacion.Attributes.Add("style", "color: blue");
        lblDepartamento.Attributes.Add("style", "color: blue");
        lblDetalles.Attributes.Add("style", "color: blue");
        //------------------------------------------------------------
        string tipo_inmueble = txtSubTipoInmueble.Text;
        if (tipo_inmueble == "Casa")
        {
            lblCaracteristicas.Visible = false;
            checkCaracteristicas.Visible = false;
            lblDepartamento.Visible = false;
            txtDepartamento.Visible = false;
            lblDetalles.Visible = false;
            txtDetalles.Visible = false;
            lblTipoSuelo.Visible = false;
            txtTipoSuelo.Visible = false;
            txtArea_Total.Visible = false;
            lblArea_Total.Visible = false;
        ...
        if (tipo_inmueble == "Terreno")
        {
            lblDepartamento.Visible = false;
            txtDepartamento.Visible = false;
            txtNPiso.Visible = false;
            lblNro_Pisos.Visible = false;
            lblAdicionales.Visible = false;
            lblAmbientes.Visible = false;
            checkAdicionales.Visible = false;
            checkAmbientes.Visible = false;
            txtTipoServicio.Visible = false;
            checkServicios.Visible = false;
            lblDormitorios.Visible = false;
            txtDormitorio.Visible = false;
            txtBaño.Visible = false;
            lblBaños.Visible = false;
            txtCochera.Visible = false;
            lblCocheras.Visible = false;
        }
    ...
    protected void btnGF_Click(object sender, EventArgs e)
    {
        if (Session["id_persona"] == null)
        {
            Response.Redirect("inicio.aspx");
